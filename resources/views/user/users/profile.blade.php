        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{$profile->photo}}" alt="ảnh đại diện">
                        @else 
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('backend/img/avatar.png')}}" alt="ảnh đại diện">
                        @endif
                    </div>
                      ...
                      <div class="form-group">
                          ...
                          <select name="role" class="form-control">
                              <option value="">-----Chọn vai trò-----</option>
                                  ...
                                  <option value="user" {{(($profile->role=='user')? 'selected' : '')}}>Người sử dụng</option>
                          </select>
                        @error('role')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
