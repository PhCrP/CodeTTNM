									...
									<div class="product_filter">
										...
										<div class="label-input">
											...
											<div class="custom-price">
												...
												<input type="number" id="custom-min" name="custom-min" min="0" placeholder="0" />
												<label for="custom-max">Giá tối đa:</label>
												<input type="number" id="custom-max" name="custom-max" min="0" placeholder="1000000" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-8 col-md-6 col-12">
									<div class="list-content">
										<div class="product-content">
											...
											<h3 class="title"><a href="{{ auth()->check() ? route('product-detail', $product->slug) : route('login.form', ['redirect' => route('product-detail', $product->slug)]) }}">{{$product->title}}</a></h3>
											{{-- <p>{!! html_entity_decode($product->summary) !!}</p> --}}
										</div>
										<p class="des pt-2">{!! html_entity_decode($product->summary) !!}</p>
										<a href="{{ route('under.development') }}" class="btn" data-id="{{$product->id}}">Mua ngay!</a>
									</div>
								</div>
							</div>
						</div>
