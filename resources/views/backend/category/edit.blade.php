    ...
    <div class="card-body">
      <form method="post" action="#">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="summary" name="summary">Thisssssssssss</textarea>
          @error('summary')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        <div class="form-group mb-3">
          <a class="btn btn-success custom-button" href="{{ route('admin.under-development') }}">Cập nhật</a>
        </div>
      </form>
    </div>
</div>
